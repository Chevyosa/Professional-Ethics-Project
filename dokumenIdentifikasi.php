...
<head>
    ...
    <title>Langkah 2 - Dokumen Identifikasi</title>
    <style>
...
<body>
  ...
  <div class="container" id="buktiDigital">
    <div class="card">
      ...
      <h3>Langkah 2  -  Upload Dokumen Identifikasi</h3>

      <div class="upload-section">
        <div class="drop_box" id="idCardDropBox">
          <h4>1. Kartu Identitas atau Paspor</h4>
          <p>Pengguna dapat mengunggah salinan kartu identitas atau paspor.</p>
          <input type="file" hidden accept="image/*" id="fileIdCard" style="display:none;">
          <button class="btn" onclick="document.getElementById('fileIdCard').click()">Pilih File</button>
        </div>
        <div class="drop_box" id="membershipProofDropBox">
          <h4>2. Bukti Keanggotaan atau Akun</h4>
          <p>Pengguna dapat melampirkan bukti keanggotaan atau bukti kepemilikan akun.</p>
          <input type="file" hidden accept=".txt, .log" id="fileMembershipProof" style="display:none;">
          <button class="btn" onclick="document.getElementById('fileMembershipProof').click()">Pilih File</button>
        </div>
      </div>
  ...
  <script>
    const idCardInput = document.getElementById("fileIdCard");
    const membershipProofInput = document.getElementById("fileMembershipProof");
    ...
    setupFileUpload(idCardInput, document.getElementById("idCardDropBox"));
    setupFileUpload(membershipProofInput, document.getElementById("membershipProofDropBox"));
    nextBtn.onclick = function () {
    window.location.href = "dokumenPendukungKeuangan.html";
  };
