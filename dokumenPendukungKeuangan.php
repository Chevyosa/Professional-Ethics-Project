...
<head>
  ...
  <title>Langkah 3 - Dokumen Pendukung Keuangan</title>
  <style>
    ...
    * {
    ...
    .upload-section {
      ...
      /* Mengubah orientasi container menjadi kolom */
    }

    .drop_box {
      flex: 0.48;
      /* 48% of the container width */
      margin: 10px 0;
      padding: 20px;
      display: flex;
      align-items: center;
    ...
    .next-btn {
      ...
      z-index: 99;
      top: 70%;
      /* Sesuaikan dengan jarak yang diinginkan dari atas */
      border-radius: 5pt;
      margin-left: 580px;
...
<body>
  ...
  <div class="container" id="dokumenPendukungKeuangan">
    <div class="card">
      <h3>Langkah 3 - Upload Dokumen Pendukung Keuangan</h3>

      <div class="upload-section">
        <div class="drop_box" id="transactionProofDropBox">
          <h4>Bukti Transaksi atau Tagihan</h4>
          <p>Jika insiden melibatkan transaksi keuangan yang mencurigakan, pengguna dapat melampirkan bukti transaksi atau tagihan terkait.</p>
          <input type="file" hidden accept=".pdf, .doc, .docx" id="fileTransactionProof" style="display:none;">
          <button class="btn" onclick="document.getElementById('fileTransactionProof').click()">Pilih File</button>
        </div>
  ...
  <script>
    const transactionProofInput = document.getElementById("fileTransactionProof");
    ...
    setupFileUpload(transactionProofInput, document.getElementById("transactionProofDropBox"));
    nextBtn.onclick = function () {
      window.location.href = "dokumenPelaporanSebelumnya.html";
    };
  </script>
